...
class Task extends Controller
{
    ...
    public function task_add_update($id= NULL)
    {
        ...
        if(isPost())
        {
            ...
            if($data["_id"]=="")
            {
                ...
                {
                    flashToast("taskAddSuccess","Task Added Successfully");
                    echo "<script>window.location.href = '".URLROOT."/Task/taskList';</script>";
                }
                else
                {
                    flashToast("taskExist","Task Already Assigned");
            ...
            else
            {
                ...
                if($response['response']==true)
                {
                    flashToast("taskUpdateSuccess","Task Updated Successfuly");
                    echo "<script> window.location.href = '".URLROOT."/Task/taskList';</script>";
                }
                else
                {
    ...
    public function DeleteByIdTask($id)
    {
        ...
        if($response["response"]==true){
            ...
            flashToast("taskDeleteSuccess","Task Deleted Successfuly");
            echo "<script> window.location.href = '".URLROOT."/Task/taskList';</script>";
        }
        else
        {
