		...
		<div class="cls-content">
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            ...
		            <form method="post" action="<?=URLROOT;?>/Login/index">
                        ...
                        <input type="hidden" id="ip_address" name="ip_address" value="192.168.0.0">
		                <div class="form-group">
		                    <input type="text" id="user_name" name="user_name" class="form-control" placeholder="Username" autofocus autocomplete="off">
		                </div>
		        ...
		        <div class="pad-all">
		            <a href="<?=URLROOT;?>/Home/index" class="btn-link mar-rgt">Back To Home</a>
		        </div>
		    </div>
		</div>
    </div>
    <script src="<?=URLROOT;?>/common/assets/js/jquery.min.js"></script>
    <script src="<?=URLROOT;?>/common/assets/otherJs/loginjs.js"></script>
</body>
</html>