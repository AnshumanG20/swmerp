            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-lg-right" style="padding-right: 20px; padding-top:10px;">
                                <a href="<?=URLROOT;?>/Invoice/invoice_list/"><button id="demo-foo-collapse" class="btn btn-purple"><i class="fa fa-arrow-left"></i> Back</button></a>
                            </div>
                        </div>
                    </div>
                    <!--Horizontal Form-->
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="<?=URLROOT;?>/Invoice/invoice_add_update/<?=$data["_id"];?>">
                            <div class="form-group">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-4">
                                    <select id="cust_type" name="cust_type" class="form-control" onchange="getCustomerDetails(this.id);">
                                        ...
                                        <option value="<?=$value["customer_name_id"]?>" <?=(isset($data["contact_details_id"]))?($data["contact_details_id"]==$value["customer_name_id"])?"SELECTED":"":"";?>><?=$value["contact_name"]?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label text-bold" for="invoice_no">Invoice No.<span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" maxlength="50" id="invoice_no" name="invoice_no" class="form-control" value="<?=(isset($data['invoice_no']))?$data['invoice_no']:"";?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label text-bold" for="invoice_date">Invoice Date<span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group date">
                                        <input type="text" id="invoice_date" name="invoice_date" value="<?=(isset($data['invoice_date']))?$data['invoice_date']:date('Y-m-d');?>" class="form-control mask_date" placeholder="Click Here To Select From Date">
                                        <input type="hidden" id="hidden_date" name="hidden_date" value="<?=(isset($data['invoice_date']))?$data['invoice_date']:date('Y-m-d');?>" class="form-control mask_date" />
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label text-bold" for="payment_due_date">Due Date<span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group date">
                                            ...
                                            <div class="tangg table-responsive">
                                                <table class="table table-hover table-bordered table-condensed" id="rowAdditem">
                                                    ...
                                                    <tbody id="rowAddInvoiceDetails">
                                                        <?php
                                                        if(isset($data['invoiceEditAsset'])){
                                                            $i = 0;
                                                            foreach($data['invoiceEditAsset'] as $value){
                                                                $i++;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" id="item_quantity<?=$i;?>" name="item_quantity[]"  class="form-control item_quantity" onkeyup="calQuantityRateToAmount(this.id);" onchange="calQuantityRateToAmount(this.id);" value="<?=$value['item_quantity'];?>" readonly="readonly" /></td>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:right;" >
                                                                ...
                                                                ?>
                                                                <input type="number" name="discount_rate" id="discount_rate" class="form-control m-t-xxs" value="<?=(isset($data["discount_rate"]))?$data["discount_rate"]:"0.00";?>"  onkeyup="calTaxAmount()"/>
                                                            </td>
                                                            <td style="text-align:right;">
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label class="control-label text-bold" for="customer_note">Customer Notes<span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-8">
                                    <textarea class="form-control" type="text" name="customer_note" id="customer_note"><?=(isset($data["customer_note"]))?$data["customer_note"]:"Thanks for your business.";?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <button class="btn btn-success" id="btn_add_update_invoice_details" name="btn_add_update_invoice_details" type="submit"><?=(isset($data["_id"]))?($data["_id"])?"Update Invoice":"Generate Invoice":"Generate Invoice";?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script type="text/javascript">
	...
	var invoice_date = new Date(this.value);
	var payment_due_date = new Date(invoice_date);
...
<script type="text/javascript">
    ...
    function getCustomerDetails(){
        ...
        if(cust_type!=""){
            $.ajax({
                type:"POST",
                url: "<?=URLROOT;?>/Invoice/ajaxcustomerDetails",
                dataType: "json",
    ...
    function getItemList(ID){
        ...
        if(asset_type!=""){
            ...
            $.ajax({
                type:"POST",
                url: "<?=URLROOT;?>/Invoice/ajaxItemListByAssetType",
                dataType: "json",
    ...
    function getSubItemList(ID){
        ...
        if(item_mstr_id!=""){
            ...
            $.ajax({
                type:"POST",
                url: "<?=URLROOT;?>/Invoice/ajaxSubItemListByItemList",
                dataType: "json",
    ...
    function getSubItemDetails(ID){
        ...
        if(sub_item_mstr_id!=""){
            ...
            $.ajax({
                type:"POST",
                url: "<?=URLROOT;?>/Invoice/ajaxSubItemDetails",
                dataType: "json",
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#btn_add_update_invoice_details').click(function(){
            ...
            if(invoice_date < hidden_date)
            {
                alert('Invoice Date Must Be Current Date Or Any New Date');
                $("#invoice_date").css({"border-color":"red"});
                $("#invoice_date").focus();
                process = false;
            }
            ...
            {
                alert('Due Date Must Be Greater Than Or Equals To Invoice Date');
                $("#payment_due_date").css({"border-color":"red"});
                $("#payment_due_date").focus();
                process = false;
            }
