					        ...
					        <div class="panel">
                                ...
                                <div class="panel-body">
                                    <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                    <?php
                                    if(isset($data["notificationList"])):
                                    ...
                                    <?php else:
                                            $i=0;
                                            foreach ($data["notificationList"] as $value):
                                    ?>
                                            <tr>
                                                <td><?=++$i;?></td>
                                                ...
                                                <td>
                                                    ...
                                                    {
                                                        ?>
                                                         <a href="<?=URLROOT;?>/<?=$value["link"];?>" class="btn btn-success">View</a>
                                                        <?php
                                                    }
                                                    else {
                                                        ?>
                                                         <a href="#" class="link-primary" disabled >Closed</a>
                                                        <?php
                                                    }
                                                    ?>
                                                </td>
