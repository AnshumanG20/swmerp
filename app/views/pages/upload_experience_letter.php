					        ...
					        <div class="panel">
                                <div class="panel-heading">
                                    ...
                                    <div class="pad-btm col-md-12">
                                        <a href="<?=URLROOT;?>/Termination/termination_List" class="btn btn-danger" style="float:right;"><i class="fa fa-arrow-left" aria-hidden="true"></i>           Back</a>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <form method="post" action="<?=URLROOT;?>/Termination/upload_experience_letter" enctype="multipart/form-data">
                                        <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <embed src="<?=URLROOT.'/uploads/'.$data['get_experience_letter']['create_experience_letter'];?>" width="100%" height="100%" />
                                    </div>
                                </div>
					        </div>
					    </div>
