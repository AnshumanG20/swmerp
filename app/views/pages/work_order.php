            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h5 class="panel-title"> Work Order</h5>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="pad-btm">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#updateWorkOrder">
                                Edit
                            </button>
                        </div>
                        <div class ="row">
                            <div class="col-md-12">
                                <!-- The Modal -->
                                <div class="modal" id="updateWorkOrder">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <!-- Modal body -->
                                            <form method="post"  id="upworkorder" action="<?=URLROOT;?>/Estimate/edit_work_order">
                                            <div class="modal-body">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <div class="input-group date">
                                                                ...
                                                                <input class="form-control datePicker" type="hidden"  id="hidden_date" name="hidden_date" value="<?=$data["WorkOrderList"]["work_order_received_date"];?>"/>
                                                                <input class="form-control datePicker" type="text"  id="work_order_received_date" name="work_order_received_date" value="<?=$data["WorkOrderList"]["work_order_received_date"];?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <input type="file" id="work_order_attach_path" name="work_order_attach_path" class="form-control m-t-xxs" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <textarea class="form-control m-t-xxs" type="text" name="work_order_remarks" id="work_order_remarks" required><?=$data["WorkOrderList"]["work_order_remarks"];?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <button type="submit" id="btn_add_update_work_order" name="btn_add_update_work_order" class="btn btn-md btn-success btn-block">Update Work Order <i class="fa fa-arrow-right"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <form method="post"  id="dvContainer" action="<?=URLROOT;?>/Estimate/edit_work_order">
                                    <div class="row">
                                                ...
                                                <table class="table" width="100%" style="margin-top:10px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="font-size:11px;height:90px;">
                                                            ...
                                                            <td style="text-align:right;border-bottom: 1pt dotted #E4E2E1;"><?=number_format($value["item_quantity"]);?></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="input-group date">
                                                    <?=$data["WorkOrderList"]["work_order_received_date"];?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <a target="_blank" href="<?= URLROOT ?>/public/uploads/<?=$data["WorkOrderList"]["work_order_attach_path"];?>" class="btn btn-dark btn-sm">Document View</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <?=$data["WorkOrderList"]["work_order_remarks"];?>
                                            </div>
                                        </div>
                                    </div>
