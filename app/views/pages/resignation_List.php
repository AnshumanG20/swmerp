...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Resign Employee List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
					    ...
					    <div class="col-sm-12">
					        <div class="panel">
                                <div class="panel-heading">
					                <h5 class="panel-title">Resign Employee List</h5>
                                </div>
                                <div class="panel-body">
					                ...
					                <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php
                                            if(isset($data["resignation_List"])):
                                            if($data["resignation_List"]==""):
                                            ?>
                                            <tr>
                                            ...
                                            <?php else:
                                            $i=0;
                                            foreach ($data["resignation_List"] as $value): ?>
                                            <tr>
                                                <td><?=++$i;?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php }elseif($value["_status"]==2){ ?>
                                                        <b class="text-success">Resignation Process Pending...</b>
                                                   <?php }elseif($value["_status"]==3){ ?>
                                                        <b class="text-warning">Rejected</b>
                                                   <?php }elseif($value["_status"]==4){ ?>
                                                        <b class="text-success">Experience Letter Pending</b>
                                                   <?php }elseif($value["_status"]==5){ ?>
                                                        <b class="text-info">Resignation Process Completed</b>
                                                   <?php }elseif($value["_status"]==6){ ?>
                                                        <b class="text-info">Account Process Completed</b>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?=URLROOT;?>/resignation_Controller/generate_experience_letter/<?=$value["_id"];?>" class="btn btn-success">Generate Experience Letter</a>
                                                    <?php }elseif($value["_status"]==5){ ?>
                                                    <a href="<?=URLROOT;?>/resignation_Controller/upload_experience_letter/<?=$value["_id"];?>" class="btn btn-primary">Upload Experience Letter</a>
                                                    <?php }elseif($value["_status"]==7){ ?>
                                                    <a href="<?=URLROOT;?>/resignation_Controller/view_experience_letter/<?=$value["_id"];?>" class="btn btn-primary">View Experience Letter</a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php endforeach;?>
