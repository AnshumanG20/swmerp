            ...
            <div class="col-sm-12">
                <div class="panel">
                    <div class="panel-heading">
                        <h5 class="panel-title">Assign Task List</h5>
                    </div>
                    <div class="panel-body">
                        <div class="pad-btm">
                            <div class ="row">
                                <div class="col-sm-12">
                                    <div class="row">
                                        <form class="form-horizontal" method="post" action="<?=URLROOT;?>/Task_Assign/task_assign_list">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <!-- <td><?=$value["assign_by_emp_name"];?></td>//-->
                                    ...
                                    <td>
                                        <?php if($value["receive_reject_status"]==1){?>
                                        <a class="btn btn-primary" href="<?=URLROOT;?>/Task_Assign/task_assign_add_update/<?=$value["_id"];?>" role="button">Edit</a>
                                        <?php } 
                                        else{?>
                                        N/A
                                        <?php }
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php if ($msgg = flashToast("taskAssignSuccess")) { ?>
            modelInfo("<?=$msgg;?>"); 
        <?php } ?>
        ...
        <?php if ($msgg = flashToast("taskAssignUpdateSuccess")) { ?>
            modelInfo("<?=$msgg;?>"); 
        <?php } ?>
    ...
    function deletefun(ID)
    {
        ...
        if(result)
            window.location.replace("<?=URLROOT;?>/Task_Assign/DeleteByIdTask/"+ID);
    }
