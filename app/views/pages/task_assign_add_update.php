                    ...
                    <form class="form-horizontal" method="post" action="<?=URLROOT;?>/Task_Assign/task_assign_add_update/<?=(isset($data['_id']))?$data['_id']:'';?>">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select id="project_mstr_id" name="project_mstr_id" class="form-control" readonly>
                                        <!--<option value="">--select--</option>//-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select id="task_list_mstr_id" name="task_list_mstr_id" class="form-control">
                                        <option value="">--select--</option>
                                        <?php 
                                        if(isset($data["task"])){
                                            foreach($data["task"] as $value){

                                                // echo '<pre>';print_r($value);return;
                                        ?>
                                        <option value="<?=$value["_id"]?>" <?=(isset($data["task_list_mstr_id"]))?($data["task_list_mstr_id"]==$value["_id"])?"SELECTED":"":"";?>><?=$value["task_name"]?></option>
                                        <?php 
                                            }
                                        ?>
                                        <option value="0" <?=(isset($data["task_list_mstr_id"]))?($data["task_list_mstr_id"]==0)?"SELECTED":"":"";?>>Other</option>
                                        <?php
                                        ?>
                                        <option value="0" <?=(isset($data["task_list_mstr_id"]))?($data["task_list_mstr_id"]==0)?"SELECTED":"":"";?>>Other</option>
                                        <?php
                            ...
                            <div class="panel-footer text-center">
                                <button class="btn btn-success" id="btn_task_assign" name="btn_task_assign" type="submit"><?=(isset($data["_id"]))?"Edit Task":"Assign Task";?></button>
                                <a href="<?=URLROOT;?>/Task_Assign/task_assign_list" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Back To List</a>
                            </div>
                            <div class="row">
    ...
    $(document).ready( function () {
        ...
        $("#btn_task_assign").click(function() {
            ...
            var remarks_by_assigned = $('#remarks_by_assigned').val();
                remarks_by_assigned = remarks_by_assigned.trim();
