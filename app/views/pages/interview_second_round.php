					    ...
					    <div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Second Round Interview Process Panel</h3>
					            </div>
					                        ...
					                        <div class="col-sm-6">
					                            <div class="form-group">
					                                ...
					                                <select class="form-control" id="candidate_name" name="candidate_name">
                                                        ...
                                                        <?php if(isset($data["interviewSecondList"])):?>
                                                        <?php foreach ($data["interviewSecondList"] as $key => $value):?>
...
$(document).ready(function(){
	$("#candidate_name").on('change',function(){
		...
		$.ajax({
			type:'POST',
			url:'<?=URLROOT;?>/InterviewProcessController/fetch_candidate_second_round_details',
