                                                    ...
                                                    <tr>
                                                        <td>
															<div style="margin-left:190px;">
														        ...
														        <!-- <span style="font-weight:bold; font-size:1.8em;margin-bottom:6px;"><?php //echo $data["EmpCompLocList"]["company_name"];?></span><br/> -->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <center><table width="600" border="1">
                                                                ...
                                                                <tr>
                                                                    <td>&nbsp;&nbsp;Basic Salary</td>
                                                                    <td>&nbsp;&nbsp;<?=$data["EmpSalList"]["basic_salary"];?></td>
                                                                ...
                                                                <tr>
                                                                    <td>&nbsp;&nbsp;Incentives</td>
                                                                    <td>&nbsp;&nbsp;<?=$data["EmpSalList"]["incentive_amt"];?></td>
                                                                    <td>&nbsp;</td>
                                                                    <td>&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>&nbsp;&nbsp;<?=$gross_salary+$data["EmpSalList"]["incentive_amt"];?></td>
                                                                    <td>&nbsp;&nbsp;Total Deduction</td>
                                                                    <td>&nbsp;&nbsp;<?=round($total_deduct_sal,2);?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;&nbsp;</td>
                                                                    <td>&nbsp;&nbsp;</td>
                                                                    <td>&nbsp;&nbsp;<b>Net Salary</b></td>
                                                                    <td>&nbsp;&nbsp;<?=$data["EmpSalList"]["prepared_salary"];?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;&nbsp;</td>
                                                                    <td>&nbsp;&nbsp;</td>
                                                                    <td>&nbsp;&nbsp;<b>Final Salary</b></td>
                                                                    <td>&nbsp;&nbsp;<?=$data["EmpSalList"]["final_prepared_salary"];?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;&nbsp;</td>
                                                                    <td>&nbsp;&nbsp;</td>
