					...
					<div class="row">
					    <div class="col-sm-12">
					        <div class="panel">
					            ...
					            <!--Horizontal Form-->
					            <!--===================================================-->
					            <form class="form-horizontal" method="post" action="<?=URLROOT;?>/Masters/sub_qualification_add_update/<?=(isset($data['_id']))?$data['_id']:'';?>">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" maxlength="50" placeholder="Enter Stream" id="stream_name" name="stream_name" class="form-control" value="<?=(isset($data['stream_name']))?$data['stream_name']:"";?>" onkeypress="return isAlpha(event);" >
                                            </div>
                                        </div>
                                        <div class="panel-footer text-center">
                                            <button class="btn btn-success" id="btnsubqualification" name="btnsubqualification" type="submit"><?=(isset($data["_id"]))?"Edit Stream":"Add Stream";?></button>
...
$(document).ready( function () {
    ...
    function modelInfo(msg)
        ...
        <?php if ($msgg = flashToast("subQualExist")) { ?>
            modelDanger("<?=$msgg;?>"); 
        <?php } ?>
