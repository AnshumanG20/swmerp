...
<head>
    ...
    <title>Fixed Navbar | Nifty - Admin Template</title>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Fixed Navbar</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<div class="row">
					    <div class="col-lg-6 col-lg-offset-3">
					        <div class="alert alert-info media">
					            <div class="media-left">
					                    <i class="psi-information icon-2x"></i>
					            </div>
					            <div class="media-body">
					                <h4 class="alert-title">Fixed Navbar</h4>
					                <p class="alert-message">Keep your navbar fixed at the top of pages. <br>To see the difference between static and fixed top navbars, just scroll.</p>
					            </div>
					        </div>
					        <hr>
					        <div class="thumbnail">
					            <img src="img//bg-img/1.jpg" alt="Image">
					        </div>
					        <h4 class="text-semibold">Sample Text</h4>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li class="list-divider"></li>
											<li class="active-link"><a href="layouts-fixed-navbar.html">Fixed Navbar</a></li>
