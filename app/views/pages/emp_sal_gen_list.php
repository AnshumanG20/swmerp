					    ...
					    <div class="col-sm-12">
					        <div class="panel">
                                <div class="panel-heading">
					                <h5 class="panel-title">Employee Salary Generate List</h5>
                                </div>
                                <div class="panel-body">
                                    <div class="pad-btm">
                                        <a href="<?=URLROOT;?>/SalaryController/Generate_Sal_Emp_List"><button id="demo-foo-collapse" class="btn btn-purple">Generate Salary  <i class="fa fa-arrow-right"></i></button></a>
                                    </div>
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=URLROOT;?>/SalaryController/emp_sal_gen_list">
                                            ...
                                            <table id="demo_dt_basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Present Days </th>
                                                        <th>Paid Leave</th>
                                                        <th>Prepared Salary<br/><i class="text-danger" style="font-size:10px;">(in Rs.)</i></th>
                                                        <th>Final Prepared Salary<br/><i class="text-danger" style="font-size:10px;">(in Rs.)</i></th>
                                                        <th>Salary Slip</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    // print_r($data["EmpSalGenList"]);
                                                    if(isset($data["EmpSalGenList"])):
                                                    if($data["EmpSalGenList"]==""):
                                                    ?>
                                                    <tr>
                                                    ...
                                                    <?php else:
                                                    $i=0;
                                                    foreach ($data["EmpSalGenList"] as $value):
                                                    ?>
                                                    <tr>
                                                        <td><?=++$i;?></td>
                                                        <td><?=(isset($value['first_name']))?$value["first_name"]:"";?>
                                                            ...
                                                            <br/>Emp Code:<?=(isset($value['employee_code']))?$value['employee_code']:"N/A";?>
                                                        </td>
                                                        <td><?=$value["employment_type"];?><br/><span class="text-danger"><?=(isset($value['work_type']))?'('.$value['work_type'].')':"";?></span></td>
                                                        <td><?=$value["month_year"];?></td>
                                                        <td><?=$value["working_days"];?></td>
                                                        <td><?=$value["present_days"];?></td>
                                                        <td><?=$value["paid_leave"];?></td>
                                                        <td><?=$value["prepared_salary"];?></td>
                                                        <td><?=$value["final_prepared_salary"];?></td>
                                                        <td><a href="<?=URLROOT;?>/SalaryController/salary_slip/<?=$value["_id"];?>" class="btn btn-warning">View</a></td>
                                                    </tr>
                                                    <?php endforeach;?>
                                                    <?php endif;  ?>
                                                    <?php endif;  ?>
