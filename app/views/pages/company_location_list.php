...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Company Branch List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
					    ...
					    <div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h5 class="panel-title">Company Branch List</h5>

					            </div>
                                <div class="panel-body">
                                     <div class="pad-btm">
                                        <a href="<?=URLROOT;?>/Company_Details/companylocation_add_update"><button id="demo-foo-collapse" class="btn btn-purple">Add New <i class="fa fa-arrow-right"></i></button></a>
                                    </div>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?=$value["company_gstin_no"];?></td>
                                                <td><?=$value["website"];?></td>
                                                <td><?=$value["address"];?></td>
                                                <td><?=$value["pin"];?></td>
                                                <td><?=$value["contact_no"];?></td>
                                                <td><?=$value["email_id"];?></td>
                                                <td><?=$value["state_dist_city_id"];?></td>
                                                <td><?=$value["country_id"];?></td>
                                                <td><?=$value["company_type"];?></td>

                                                <td>
                                                    <a class="btn btn-primary" href="<?=URLROOT;?>/Company_Details/companylocation_add_update/<?=$value["_id"];?>" role="button">Edit</a>
                                                        &nbsp;&nbsp;
 ...
 function deletefun(ID)
{
    ...
    if(result)
     window.location.replace("<?=URLROOT;?>/Company_Details/DeleteByIdLocation/"+ID);
}
