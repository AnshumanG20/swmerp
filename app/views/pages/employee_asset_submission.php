...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Employee Assets Submission</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
					    ...
					    <div class="col-sm-12">
					        <div class="panel">
					            <div class="panel-heading">
					                <h3 class="panel-title">Employee Assets Submission Form</h3>
					            </div>
					            <!--Horizontal Form-->
                                <!--===================================================-->
                                ...
                                ?>
                                 <?php
                                    if(isset($data["employee_asset_details"])):
                                ?>
                                <form class="form-horizontal" method="post" action="<?=URLROOT;?>/resignation_Controller/emp_resignation_inventory_notification">
                                    <div class="panel-body">
                                        <input type="hidden" id="url" name="url" class="form-control" value="<?=$url;?>">
                                        <input type="hidden" id="quit_id" name="quit_id" class="form-control" value="<?=$data["employee_asset_details"]["_id"];?>">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Employee Name </label>
                                            <div class="col-sm-3" >
                                                <input type="hidden" id="emp_id" name="emp_id" class="form-control" value="<?=$data["employee_asset_details"]["emp_id"];?>">
                                                <input type="text" id="emp_name" name="emp_name" class="form-control" value="<?=$data["employee_asset_details"]["first_name"]." ".$data["employee_asset_details"]["middle_name"]." ".$data["employee_asset_details"]["last_name"];?>" readonly style=" border: none;">
                                            </div>
                                            <label class="col-sm-2 control-label">Employee Code </label>
                                            <div class="col-sm-3" >
                                                <input type="text" id="emp_code" name="emp_code" class="form-control" value="<?=$data["employee_asset_details"]["employee_code"];?>" readonly style=" border: none;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Employee Designation </label>
                                            <div class="col-sm-3" >
                                                <input type="text" id="emp_designation" name="emp_designation" class="form-control" value="<?=$data["employee_asset_details"]["designation_name"];?>" readonly style=" border: none;">
                                            </div>
                                            <label class="col-sm-2 control-label" for="design">Date Of Joining </label>
                                            <div class="col-sm-3" >
                                                <input type="text" id="doj" name="doj" class="form-control" value="<?=$data["employee_asset_details"]["joining_date"];?>" readonly style=" border: none;">
                                            </div>
                                        </div>
                                        <hr>
                                                        ...
                                                        <table class="table table-hover table-bordered table-condensed" >
                                                            ...
                                                            <tbody id="assets_id">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" maxlength="50" id="assets_name" name="assets_serial_no[]" class="form-control" value="<?=$value["asset_barcode_no"];?>" readonly/>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td><input type="text" maxlength="6" id="penalty<?=$z;?>" name="penalty[]" class="form-control penalty" value="" onkeypress="return isDecNum(this, event);" onkeyup="changeBorderNormal(this.id);"/>
                                                                    </td>
                                                                    <td><input type="text" maxlength="6" id="net_Amount" name="net_Amount[]" class="form-control" value="<?=$value["purchase_cost"];?>" readonly/></td>
                                                                </tr>
                                                                <?php endforeach;?>
                                                                <?php endif;  ?>
                                                                <?php endif;  ?>
