...
<!--CONTENT CONTAINER-->
            ...
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">Organisation Bank Account List</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                </div>
					    ...
					    <div class="col-sm-12">
					        <div class="panel">
                                <div class="panel-heading">
					                <h5 class="panel-title">Organisation Bank Account List</h5>
                                </div>
                                <div class="panel-body">
									<div class="pad-btm">
                                        <a href="<?=URLROOT;?>/BankVoucher/add_update_bankvoucher"><button id="demo-foo-collapse" class="btn btn-purple">Add New <i class="fa fa-arrow-right"></i></button></a>
                                    </div>
                                    <div class ="row">
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="<?=URLROOT;?>/BankVoucher/bank_voucher_list">
												...
												<div class="col-md-3">
                                                    ...
                                                    <option value="PAYMENT_VOUCHER_INCOME" <?=(isset($data["PAYMENT_VOUCHER_INCOME"]))?($data["PAYMENT_VOUCHER_INCOME"]=="PAYMENT_VOUCHER_INCOME")?"selected":"":"";?>>PAYMENT/VOUCHER_INCOME</option>
												</select>
                                                </div>
												<div class="col-md-3">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
													<a class="label label-warning" href="<?=URLROOT;?>/BankVoucher/add_update_bankvoucher/<?=$value["transaction_id"];?>" role="button">Edit  <i class="fa fa-edit"></i></a>
													&nbsp;&nbsp;
...
$('#from_date').datepicker({ 
	...
	$(document).ready(function() {
        ...
        <?php if ($msgg = flashToast("addSuccess")) { ?>
            modelInfo("<?=$msgg;?>"); 
        <?php } ?>
